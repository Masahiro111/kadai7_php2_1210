        ...
        <div class="md:grid md:grid-cols-3 md:gap-6">
            <div class="md:col-span-1">
                <div class="px-4 sm:px-0">
                    <h3 class="text-lg font-medium leading-6 text-gray-900">ブックマークの更新</h3>
                    <p class="mt-1 text-sm text-gray-600">各フォームに必要事項を記入し「更新する」ボタンをクリックしてください。</p>
                </div>
            </div>
                ...
                <form method="POST" action="{{ route('bookmarks.update', $bookmark) }}">
                    ...
                    <div class="shadow sm:overflow-hidden sm:rounded-md">
                        ...
                        <div class="bg-gray-50 px-4 py-3 text-right sm:px-6">
                            <button type="submit" class="inline-flex justify-center rounded-md border border-transparent bg-indigo-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">更新する</button>
                        </div>
                    </div>
                </form>
            </div>
